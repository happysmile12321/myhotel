...
<body>
  ...
  <div class="medium-3 columns" style="background-color:#f1f1f1;">
    <ul class="side-nav">
      ...
      <li><a href="files/tuifang/tuifanglist.jsp" id="aaa">退房</a></li>
      <li><a href="roominfo" id="a2aa">房间信息</a></li>
      <li><a href="guest" id="aa3a">顾客信息</a></li>
        <li><a href="waiter" id="a4aa">服务员信息</a></li>

		<li><a href="files/yuding/yudingupdate3.jsp" id="aa33a">自定义探索栏</a></li>
    </ul>
  </div>
</div>
